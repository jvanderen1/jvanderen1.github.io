...
// .svelte-kit/output/server/chunks/[uid].json-01bf21e4.js
var uid_json_01bf21e4_exports = {};
__export(uid_json_01bf21e4_exports, {
	del: () => del,
	patch: () => patch
});
var patch, del;
var init_uid_json_01bf21e4 = __esm({
	'.svelte-kit/output/server/chunks/[uid].json-01bf21e4.js'() {
		init_shims();
		init_api_e66b1c82();
		patch = async (request) => {
...
// .svelte-kit/output/server/chunks/__layout-99c89b2c.js
var layout_99c89b2c_exports = {};
__export(layout_99c89b2c_exports, {
	default: () => _layout
});
var import_cookie, getStores, page, logo, css$1, Header, css, _layout;
var init_layout_99c89b2c = __esm({
	'.svelte-kit/output/server/chunks/__layout-99c89b2c.js'() {
		init_shims();
		init_app_f3985139();
		...
		logo = '/_app/assets/svelte-logo-adbe18bb.svg';
		css$1 = {
			code: "header.svelte-5dwhfv.svelte-5dwhfv{display:flex;justify-content:space-between}.corner.svelte-5dwhfv.svelte-5dwhfv{width:3em;height:3em}.corner.svelte-5dwhfv a.svelte-5dwhfv{display:flex;align-items:center;justify-content:center;width:100%;height:100%}.corner.svelte-5dwhfv img.svelte-5dwhfv{width:2em;height:2em;object-fit:contain}nav.svelte-5dwhfv.svelte-5dwhfv{display:flex;justify-content:center;--background:rgba(255, 255, 255, 0.7)}svg.svelte-5dwhfv.svelte-5dwhfv{width:2em;height:3em;display:block}path.svelte-5dwhfv.svelte-5dwhfv{fill:var(--background)}ul.svelte-5dwhfv.svelte-5dwhfv{position:relative;padding:0;margin:0;height:3em;display:flex;justify-content:center;align-items:center;list-style:none;background:var(--background);background-size:contain}li.svelte-5dwhfv.svelte-5dwhfv{position:relative;height:100%}li.active.svelte-5dwhfv.svelte-5dwhfv::before{--size:6px;content:'';width:0;height:0;position:absolute;top:0;left:calc(50% - var(--size));border:var(--size) solid transparent;border-top:var(--size) solid var(--accent-color)}nav.svelte-5dwhfv a.svelte-5dwhfv{display:flex;height:100%;align-items:center;padding:0 1em;color:var(--heading-color);font-weight:700;font-size:0.8rem;text-transform:uppercase;letter-spacing:0.1em;text-decoration:none;transition:color 0.2s linear}a.svelte-5dwhfv.svelte-5dwhfv:hover{color:var(--accent-color)}",
			map: null
		};
		Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
			...
			$$unsubscribe_page();
			return `<header class='${'svelte-5dwhfv'}'><div class='${'corner svelte-5dwhfv'}'><a href='${'https://kit.svelte.dev'}' class='${'svelte-5dwhfv'}'><img alt='${'SvelteKit'}'${add_attribute(
				'src',
				logo,
				0
			)} class='${'svelte-5dwhfv'}'></a></div>

  <nav class='${'svelte-5dwhfv'}'><svg aria-hidden='${'true'}' viewBox='${'0 0 2 3'}' class='${'svelte-5dwhfv'}'><path d='${'M0,0 L1,2 C1.5,3 1.5,3 2,3 L2,0 Z'}' class='${'svelte-5dwhfv'}'></path></svg>
    <ul class='${'svelte-5dwhfv'}'><li class='${[
				'svelte-5dwhfv',
				$page.path === '/' ? 'active' : ''
			]
				.join(' ')
				.trim()}'><a href='${'/'}' sveltekit:prefetch class='${'svelte-5dwhfv'}'>Home</a></li>
      <li class='${['svelte-5dwhfv', $page.path === '/about' ? 'active' : '']
				.join(' ')
				.trim()}'><a href='${'/about'}' sveltekit:prefetch class='${'svelte-5dwhfv'}'>About</a></li>
      <li class='${['svelte-5dwhfv', $page.path === '/todos' ? 'active' : '']
				.join(' ')
				.trim()}'><a href='${'/todos'}' sveltekit:prefetch class='${'svelte-5dwhfv'}'>Todos</a></li></ul>
    <svg aria-hidden='${'true'}' viewBox='${'0 0 2 3'}' class='${'svelte-5dwhfv'}'><path d='${'M0,0 L0,3 C0.5,3 0.5,3 1,2 L2,0 Z'}' class='${'svelte-5dwhfv'}'></path></svg></nav>

  <div class='${'corner svelte-5dwhfv'}'></div>
</header>`;
		});
		css = {
			code: 'main.svelte-15mtgr3.svelte-15mtgr3{flex:1;display:flex;flex-direction:column;padding:1rem;width:100%;max-width:1024px;margin:0 auto;box-sizing:border-box}footer.svelte-15mtgr3.svelte-15mtgr3{display:flex;flex-direction:column;justify-content:center;align-items:center;padding:40px}footer.svelte-15mtgr3 a.svelte-15mtgr3{font-weight:bold}@media(min-width: 480px){footer.svelte-15mtgr3.svelte-15mtgr3{padding:40px 0}}',
			map: null
		};
...
<main class='${'svelte-15mtgr3'}'>${slots.default ? slots.default({}) : ``}</main>

<footer class='${'svelte-15mtgr3'}'><p>visit <a href='${'https://kit.svelte.dev'}' class='${'svelte-15mtgr3'}'>kit.svelte.dev</a> to learn SvelteKit</p>
</footer>`;
		});
	}
});

// .svelte-kit/output/server/chunks/error-9b602ab7.js
var error_9b602ab7_exports = {};
__export(error_9b602ab7_exports, {
	default: () => Error2,
	load: () => load
});
...
// .svelte-kit/output/server/chunks/index-11fb3df1.js
var index_11fb3df1_exports = {};
__export(index_11fb3df1_exports, {
	default: () => Routes,
	prerender: () => prerender
});
...
var init_index_11fb3df1 = __esm({
  ...
  <div class='${'counter-viewport svelte-18fdd0i'}'><div class='${'counter-digits svelte-18fdd0i'}'${add_attribute(
				'style',
				`transform: translate(0, ${100 * offset}%)`,
				0
			)}><strong aria-hidden='${'true'}' style='${'top: -100%'}' class='${'svelte-18fdd0i'}'>${escape(
				Math.floor($displayed_count + 1)
			)}</strong>
      <strong class='${'svelte-18fdd0i'}'>${escape(
  ...
  <button aria-label='${'Increase the counter by one'}' class='${'svelte-18fdd0i'}'><svg aria-hidden='${'true'}' viewBox='${'0 0 1 1'}' class='${'svelte-18fdd0i'}'><path d='${'M0,0.5 L1,0.5 M0.5,0 L0.5,1'}' class='${'svelte-18fdd0i'}'></path></svg></button>
		...
		css2 = {
			code: 'section.svelte-teshqs{display:flex;flex-direction:column;justify-content:center;align-items:center;flex:1}h1.svelte-teshqs{width:100%}.welcome.svelte-teshqs{width:100%}',
			map: null
		};
		prerender = true;
...
<section class='${'svelte-teshqs'}'><h1 class='${'svelte-teshqs'}'><picture><source srcset='${'svelte-welcome.webp'}' type='${'image/webp'}'>
      <img alt='${'Welcome'}' class='${'welcome svelte-teshqs'}' src='${'svelte-welcome.png'}'></picture>
...
// .svelte-kit/output/server/chunks/about-2076347a.js
var about_2076347a_exports = {};
__export(about_2076347a_exports, {
	default: () => About,
	hydrate: () => hydrate,
...
var init_about_2076347a = __esm({
	'.svelte-kit/output/server/chunks/about-2076347a.js'() {
		...
		dev = false;
		css3 = {
			code: '.content.svelte-o8wj98{width:100%;max-width:var(--column-width);margin:var(--column-margin-top) auto 0 auto}',
			map: null
		};
		hydrate = dev;
		router = browser;
...
<div class='${'content svelte-o8wj98'}'><h1>About this app</h1>
...
// .svelte-kit/output/server/chunks/index-be7c3ccc.js
var index_be7c3ccc_exports = {};
__export(index_be7c3ccc_exports, {
	default: () => Todos,
	load: () => load2
});
var import_cookie5, css4, load2, Todos;
var init_index_be7c3ccc = __esm({
	'.svelte-kit/output/server/chunks/index-be7c3ccc.js'() {
		init_shims();
		init_app_f3985139();
		...
		init_dist();
		css4 = {
			code: `.todos.svelte-1juz249.svelte-1juz249.svelte-1juz249{width:100%;max-width:var(--column-width);margin:var(--column-margin-top) auto 0 auto;line-height:1}.new.svelte-1juz249.svelte-1juz249.svelte-1juz249{margin:0 0 0.5rem 0}input.svelte-1juz249.svelte-1juz249.svelte-1juz249{border:1px solid transparent}input.svelte-1juz249.svelte-1juz249.svelte-1juz249:focus-visible{box-shadow:inset 1px 1px 6px rgba(0, 0, 0, 0.1);border:1px solid #ff3e00 !important;outline:none}.new.svelte-1juz249 input.svelte-1juz249.svelte-1juz249{font-size:28px;width:100%;padding:0.5em 1em 0.3em 1em;box-sizing:border-box;background:rgba(255, 255, 255, 0.05);border-radius:8px;text-align:center}.todo.svelte-1juz249.svelte-1juz249.svelte-1juz249{display:grid;grid-template-columns:2rem 1fr 2rem;grid-gap:0.5rem;align-items:center;margin:0 0 0.5rem 0;padding:0.5rem;background-color:white;border-radius:8px;filter:drop-shadow(2px 4px 6px rgba(0, 0, 0, 0.1));transform:translate(-1px, -1px);transition:filter 0.2s, transform 0.2s}.done.svelte-1juz249.svelte-1juz249.svelte-1juz249{transform:none;opacity:0.4;filter:drop-shadow(0px 0px 1px rgba(0, 0, 0, 0.1))}form.text.svelte-1juz249.svelte-1juz249.svelte-1juz249{position:relative;display:flex;align-items:center;flex:1}.todo.svelte-1juz249 input.svelte-1juz249.svelte-1juz249{flex:1;padding:0.5em 2em 0.5em 0.8em;border-radius:3px}.todo.svelte-1juz249 button.svelte-1juz249.svelte-1juz249{width:2em;height:2em;border:none;background-color:transparent;background-position:50% 50%;background-repeat:no-repeat}button.toggle.svelte-1juz249.svelte-1juz249.svelte-1juz249{border:1px solid rgba(0, 0, 0, 0.2);border-radius:50%;box-sizing:border-box;background-size:1em auto}.done.svelte-1juz249 .toggle.svelte-1juz249.svelte-1juz249{background-image:url("data:image/svg+xml,%3Csvg width='22' height='16' viewBox='0 0 22 16' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M20.5 1.5L7.4375 14.5L1.5 8.5909' stroke='%23676778' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round'/%3E%3C/svg%3E")}.delete.svelte-1juz249.svelte-1juz249.svelte-1juz249{background-image:url("data:image/svg+xml,%3Csvg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M4.5 5V22H19.5V5H4.5Z' fill='%23676778' stroke='%23676778' stroke-width='1.5' stroke-linejoin='round'/%3E%3Cpath d='M10 10V16.5' stroke='white' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round'/%3E%3Cpath d='M14 10V16.5' stroke='white' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round'/%3E%3Cpath d='M2 5H22' stroke='%23676778' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round'/%3E%3Cpath d='M8 5L9.6445 2H14.3885L16 5H8Z' fill='%23676778' stroke='%23676778' stroke-width='1.5' stroke-linejoin='round'/%3E%3C/svg%3E%0A");opacity:0.2}.delete.svelte-1juz249.svelte-1juz249.svelte-1juz249:hover,.delete.svelte-1juz249.svelte-1juz249.svelte-1juz249:focus{transition:opacity 0.2s;opacity:1}.save.svelte-1juz249.svelte-1juz249.svelte-1juz249{position:absolute;right:0;opacity:0;background-image:url("data:image/svg+xml,%3Csvg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M20.5 2H3.5C2.67158 2 2 2.67157 2 3.5V20.5C2 21.3284 2.67158 22 3.5 22H20.5C21.3284 22 22 21.3284 22 20.5V3.5C22 2.67157 21.3284 2 20.5 2Z' fill='%23676778' stroke='%23676778' stroke-width='1.5' stroke-linejoin='round'/%3E%3Cpath d='M17 2V11H7.5V2H17Z' fill='white' stroke='white' stroke-width='1.5' stroke-linejoin='round'/%3E%3Cpath d='M13.5 5.5V7.5' stroke='%23676778' stroke-width='1.5' stroke-linecap='round'/%3E%3Cpath d='M5.99844 2H18.4992' stroke='%23676778' stroke-width='1.5' stroke-linecap='round'/%3E%3C/svg%3E%0A")}.todo.svelte-1juz249 input.svelte-1juz249:focus+.save.svelte-1juz249,.save.svelte-1juz249.svelte-1juz249.svelte-1juz249:focus{transition:opacity 0.2s;opacity:1}`,
			map: null
		};
...
<div class='${'todos svelte-1juz249'}'><h1>Todos</h1>

  <form action='${'/todos.json'}' class='${'new svelte-1juz249'}' method='${'post'}'><input aria-label='${'Add todo'}' name='${'text'}' placeholder='${'+ tap to add a todo'}' class='${'svelte-1juz249'}'></form>

  ${each(
		todos,
		(todo) => `<div class='${['todo svelte-1juz249', todo.done ? 'done' : '']
			.join(' ')
			.trim()}'><form action='${
			...
			todo.done ? '' : 'true',
			0
		)} class='${'svelte-1juz249'}'>
        <button class='${'toggle svelte-1juz249'}' aria-label='${
			'Mark todo as ' + escape(todo.done ? 'not done' : 'done')
		}'></button></form>

      <form class='${'text svelte-1juz249'}' action='${
			'/todos/' + escape(todo.uid) + '.json?_method=patch'
        ...
        <button class='${'save svelte-1juz249'}' aria-label='${'Save todo'}'></button></form>

      <form action='${
				'/todos/' + escape(todo.uid) + '.json?_method=delete'
			}' method='${'post'}'><button class='${'delete svelte-1juz249'}' aria-label='${'Delete todo'}' ${
...
// .svelte-kit/output/server/chunks/app-f3985139.js
			...
			start({
				...
				hydrate: ${
					...
					page: {
						...
						path: ${
							page2 && page2.path
								? try_serialize(page2.path, (error3) => {
						...
						params: ${
							page2 && page2.params
								? try_serialize(page2.params, (error3) => {
...
function init(settings = default_settings) {
	...
	options = {
		...
		dev: false,
		entry: {
			file: assets + '/_app/start-7562347b.js',
			css: [assets + '/_app/assets/start-61d1577b.css'],
			js: [assets + '/_app/start-7562347b.js', assets + '/_app/chunks/vendor-27f7137a.js']
		},
		fetched: void 0,
		floc: false,
...
function render(request, { prerender: prerender3 } = {}) {
...
${``}`;
		...
		handle = async ({ request, resolve: resolve2 }) => {
			...
			if (!cookies.userid) {
				response.headers['set-cookie'] = import_cookie6.default.serialize(
					'userid',
		...
		manifest = {
			...
			routes: [
				...
				},
				{
					...
					params: empty,
					load: () =>
						Promise.resolve().then(() => (init_index_json_784727b1(), index_json_784727b1_exports))
				},
				{
					type: 'page',
					pattern: /^\/todos\/?$/,
				...
				},
				{
					...
					params: (m) => ({ uid: d(m[1]) }),
					load: () =>
						Promise.resolve().then(() => (init_uid_json_01bf21e4(), uid_json_01bf21e4_exports))
				}
			]
		};
		get_hooks = (hooks) => ({
		...
		module_lookup = {
			'src/routes/__layout.svelte': () =>
				Promise.resolve().then(() => (init_layout_99c89b2c(), layout_99c89b2c_exports)),
			'.svelte-kit/build/components/error.svelte': () =>
				Promise.resolve().then(() => (init_error_9b602ab7(), error_9b602ab7_exports)),
			'src/routes/index.svelte': () =>
				Promise.resolve().then(() => (init_index_11fb3df1(), index_11fb3df1_exports)),
			'src/routes/about.svelte': () =>
				Promise.resolve().then(() => (init_about_2076347a(), about_2076347a_exports)),
			'src/routes/todos/index.svelte': () =>
				Promise.resolve().then(() => (init_index_be7c3ccc(), index_be7c3ccc_exports))
		};
		metadata_lookup = {
			'src/routes/__layout.svelte': {
				entry: 'pages/__layout.svelte-6a6c112a.js',
				css: ['assets/pages/__layout.svelte-60c447c3.css'],
				js: ['pages/__layout.svelte-6a6c112a.js', 'chunks/vendor-27f7137a.js'],
				styles: []
			},
			'.svelte-kit/build/components/error.svelte': {
				entry: 'error.svelte-39467f5c.js',
				css: [],
				js: ['error.svelte-39467f5c.js', 'chunks/vendor-27f7137a.js'],
				styles: []
			},
			'src/routes/index.svelte': {
				entry: 'pages/index.svelte-720c4581.js',
				css: ['assets/pages/index.svelte-9ba9104f.css'],
				js: ['pages/index.svelte-720c4581.js', 'chunks/vendor-27f7137a.js'],
				styles: []
			},
			'src/routes/about.svelte': {
				entry: 'pages/about.svelte-788cd73e.js',
				css: ['assets/pages/about.svelte-6e8ba366.css'],
				js: ['pages/about.svelte-788cd73e.js', 'chunks/vendor-27f7137a.js'],
				styles: []
			},
			'src/routes/todos/index.svelte': {
				entry: 'pages/todos/index.svelte-e71575d7.js',
				css: ['assets/pages/todos/index.svelte-1e700533.css'],
				js: ['pages/todos/index.svelte-e71575d7.js', 'chunks/vendor-27f7137a.js'],
				styles: []
			}
		};
	}
